                    ...
                    >
                            ...
                            {hasContact && (
                                <div className="text-[10px] text-[#333] mt-1 leading-snug">
                                    ...
                                    <div className="flex flex-wrap justify-center gap-x-1">
                                        {c.basics.phone && (
                                            <span className="cursor-pointer hover:text-blue-600" onClick={(e) => { e.stopPropagation(); onJumpToSourceAction('basics.phone'); }}>
                                                {c.basics.phone}
                                            </span>
                                        )}
                                        {c.basics.phone && c.basics.email && <span className="text-black/30"> · </span>}
                                        {c.basics.email && (
                                            <span className="cursor-pointer hover:text-blue-600" onClick={(e) => { e.stopPropagation(); onJumpToSourceAction('basics.email'); }}>
                                                {c.basics.email}
                                            </span>
                                        )}
                                    </div>
                                    ...
                                    <div className="flex flex-wrap justify-center gap-x-1">
                                        ...
                                        {c.basics.location && (
                                            <span className="cursor-pointer hover:text-blue-600" onClick={(e) => { e.stopPropagation(); onJumpToSourceAction('basics.location'); }}>
                                                {c.basics.location}
                                            </span>
                                        )}
                                    </div>
                        ...
                        {c.education?.length > 0 && (
                            <ResumeSection title="Education">
                                {c.education.map((edu, idx) => (
                                    <div key={edu.id} className="mb-2 cursor-pointer hover:bg-blue-50/40 rounded px-0.5 -mx-0.5 transition-colors" onClick={() => onJumpToSourceAction(`education.${idx}.school`)}>
                            ...
                            <ResumeSection title="Skills">
                                <ul className="ml-4 list-disc space-y-0.5">
                                    {c.skills.filter(s => s.items.trim()).map((skill) => (
                                        <li key={skill.id} className="text-[10px] text-[#333] leading-snug cursor-pointer hover:bg-blue-50/40 rounded transition-colors" onClick={() => onJumpToSourceAction(`skills.${skill.id}`)}>
                        ...
                        {c.projects?.length > 0 && (
                            <ResumeSection title="Projects">
                                {c.projects.map((proj, idx) => (
                                    <div key={proj.id} className="mb-2 cursor-pointer hover:bg-blue-50/40 rounded px-0.5 -mx-0.5 transition-colors" onClick={() => onJumpToSourceAction(`projects.${idx}.title`)}>
                        ...
                        {c.experience?.length > 0 && (
                            <ResumeSection title="Experience">
                                {c.experience.map((exp, idx) => (
                                    <div key={exp.id} className="mb-2 cursor-pointer hover:bg-blue-50/40 rounded px-0.5 -mx-0.5 transition-colors" data-path={`experience.${idx}.role`} onClick={() => onJumpToSourceAction(`experience.${idx}.role`)}>
                                        <div className="flex justify-between items-baseline">
                        ...
                        {c.basics.summary && (
                            <ResumeSection title="Summary">
                                <p className="text-[10px] text-[#333] leading-relaxed cursor-pointer hover:bg-blue-50/40 rounded transition-colors" onClick={() => onJumpToSourceAction('basics.summary')}>
                                    {c.basics.summary}
                                </p>
                            </ResumeSection>
                        )}
